...
## [[0.7.0](https://github.com/MuXolotl/humfmt/compare/v0.6.0...v0.7.0)] - 2026-09-19
...
- `AgoOptions::just_now(Duration)` — durations shorter than the threshold render as `"just now"` instead of `"0s ago"`. Off by default, and `Duration::ZERO` keeps it off.
